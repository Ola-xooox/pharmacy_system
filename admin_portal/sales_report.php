...
// Total Cost for today (Sum of all product costs sold)
        ...
        <main class="flex-1 overflow-y-auto p-6">
            <div id="page-content">
                <div id="sales-report-page" class="space-y-8">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-md">
                        <h2 class="text-xl font-bold mb-4 text-gray-800"><?php echo $selectedDate === date('Y-m-d') ? "Today's Transactions" : "Transactions for " . date('M j, Y', strtotime($selectedDate)); ?></h2>
            ...
            <div class="p-6 overflow-y-auto max-h-[70vh]">
                <div class="mb-4">
                    <div class="bg-orange-50 border border-orange-200 rounded-lg p-4">
                        <div class="flex justify-between items-center">
                            <span class="text-lg font-semibold text-gray-700">Total Cost for <?php echo date('M j, Y', strtotime($selectedDate)); ?>:</span>
            ...
            <div class="p-6 overflow-y-auto max-h-[70vh]">
                <div class="mb-4">
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                        <div class="flex justify-between items-center">
                            <span class="text-lg font-semibold text-gray-700">Total Revenue for <?php echo date('M j, Y', strtotime($selectedDate)); ?>:</span>
    ...
    <div id="profit-breakdown-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center hidden">
        <div class="bg-white rounded-lg shadow-xl max-w-6xl w-full mx-4 max-h-[90vh] overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-600 mt-2">Detailed profit analysis for products sold on <?php echo date('M d, Y', strtotime($selectedDate)); ?></p>
            </div>
            <div class="p-6 overflow-y-auto max-h-[70vh]">
                <div class="mb-4">
                    <div class="<?php echo $totalProfit >= 0 ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'; ?> border rounded-lg p-4">
                        <div class="flex justify-between items-center">
                            <span class="text-lg font-semibold text-gray-700">Total Profit for <?php echo date('M j, Y', strtotime($selectedDate)); ?>:</span>
