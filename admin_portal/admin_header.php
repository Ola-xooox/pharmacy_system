                ...
                <button id="user-menu-button" class="flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                    ...
                    <?php
                        ...
                        if ($profileImage) {
                            ...
                            echo '<div class="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center text-white font-bold">A</div>';
                        }
                    ?>
                </button>
                ...
                <div class="mt-6 flex justify-center">
                    <?php
                        if ($profileImage) {
                            ...
                            echo '<div class="w-24 h-24 rounded-full bg-green-500 flex items-center justify-center text-white font-bold text-4xl ring-4 ring-green-200">A</div>';
                        }
                    ?>
                </div>
                <div class="mt-4">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        // --- START: ADD THIS NEW CODE FOR THE DATE AND TIME ---
        ...
        function updateDateTime() {
            if (dateTimeElement) {
                ...
                const now = new Date();
                dateTimeElement.textContent = new Intl.DateTimeFormat('en-US', options).format(now);
            }
        }
